...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW_2-hardwere_add-subtract/HW_2-hardwere_add-subtract.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_adder_hware.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_adder_hware.tcl
