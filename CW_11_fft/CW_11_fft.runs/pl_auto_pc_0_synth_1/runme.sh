...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/CW_11_fft/CW_11_fft.runs/pl_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_auto_pc_0.tcl
