...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/CW_11_fft/CW_11_fft.runs/pl_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_floating_point_0_0.tcl
