...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/CW_11_fft/CW_11_fft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_wrapper.tcl -notrace
