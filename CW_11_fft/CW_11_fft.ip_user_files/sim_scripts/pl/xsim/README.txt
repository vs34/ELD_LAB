...
#
# Generated by export_simulation on Tue Nov 21 09:44:03 IST 2023
#
################################################################################
...
'-reset_run' switch to the './pl.sh' script.
...
For more information on the script, please type './pl.sh -help'.
