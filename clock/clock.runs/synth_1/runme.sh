...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/clock/clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voi_wrapper.tcl
