...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/clock/clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voi_wrapper.tcl -notrace
