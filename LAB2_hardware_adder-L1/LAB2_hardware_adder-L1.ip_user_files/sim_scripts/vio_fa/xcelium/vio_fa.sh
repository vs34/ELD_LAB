...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../LAB2_hardware_adder-L1.gen/sources_1/ip/vio_fa/hdl/verilog" +incdir+"../../../../LAB2_hardware_adder-L1.gen/sources_1/ip/vio_fa/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_fa xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_fa -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_fa_sc.so .tmp_log xcelium_lib waves.shm c.obj)
