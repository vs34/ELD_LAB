...
#
# Script generated by Vivado on Tue Aug 29 09:48:17 IST 2023
...
#
# Usage        : vio_fa.sh
#                vio_fa.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_fa.sh [-reset_run]
#                vio_fa.sh [-reset_log]
#                vio_fa.sh [-help]
#
...
#                script (type 'vio_fa.sh -help' for more information).
#
...
# script info
echo -e "vio_fa.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_fa.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../LAB2_hardware_adder-L1.gen/sources_1/ip/vio_fa/hdl/verilog" +incdir+"../../../../LAB2_hardware_adder-L1.gen/sources_1/ip/vio_fa/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_fa xil_defaultlib.glbl -o vio_fa_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_fa_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key vio_fa_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_fa_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_fa.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_fa.sh [-help]\n\
Usage: vio_fa.sh [-step]\n\
Usage: vio_fa.sh [-lib_map_path]\n\
Usage: vio_fa.sh [-reset_run]\n\
Usage: vio_fa.sh [-reset_log]\n\
Usage: vio_fa.sh [-keep_index]\n\
Usage: vio_fa.sh [-noclean_files]\n\n\
