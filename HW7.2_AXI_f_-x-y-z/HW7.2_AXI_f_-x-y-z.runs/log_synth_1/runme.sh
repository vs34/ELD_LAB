...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW7.2_AXI_f_-x-y-z/HW7.2_AXI_f_-x-y-z.runs/log_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log log.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source log.tcl
