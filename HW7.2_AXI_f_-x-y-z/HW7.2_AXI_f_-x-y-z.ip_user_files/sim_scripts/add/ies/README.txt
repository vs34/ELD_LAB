...
#
# Generated by export_simulation on Sat Oct 28 11:08:38 IST 2023
#
################################################################################
...
'-reset_run' switch to the './add.sh' script.
...
./add.sh -noclean_files

For more information on the script, please type './add.sh -help'.
