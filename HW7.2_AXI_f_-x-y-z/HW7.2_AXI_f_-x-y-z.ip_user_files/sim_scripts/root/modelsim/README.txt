...
#
# Generated by export_simulation on Sat Oct 28 11:10:28 IST 2023
#
################################################################################
...
'-reset_run' switch to the './root.sh' script.
...
./root.sh -noclean_files

For more information on the script, please type './root.sh -help'.
