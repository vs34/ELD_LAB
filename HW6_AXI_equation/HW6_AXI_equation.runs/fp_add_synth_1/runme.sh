...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW6_AXI_equation/HW6_AXI_equation.runs/fp_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_add.tcl
