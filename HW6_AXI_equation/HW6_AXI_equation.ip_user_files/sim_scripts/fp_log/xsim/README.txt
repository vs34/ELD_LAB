...
#
# Generated by export_simulation on Sat Oct 14 20:21:18 IST 2023
#
################################################################################
...
'-reset_run' switch to the './fp_log.sh' script.
...
./fp_log.sh -noclean_files

For more information on the script, please type './fp_log.sh -help'.
