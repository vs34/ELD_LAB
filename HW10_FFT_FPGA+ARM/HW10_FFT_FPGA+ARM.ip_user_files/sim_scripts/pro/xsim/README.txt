...
#
# Generated by export_simulation on Wed Nov 29 09:27:34 IST 2023
#
################################################################################
...
'-reset_run' switch to the './pro.sh' script.
...
./pro.sh -noclean_files

For more information on the script, please type './pro.sh -help'.
