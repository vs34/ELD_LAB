...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW10_FFT_FPGA+ARM/HW10_FFT_FPGA+ARM.runs/pro_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pro_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pro_xfft_0_0.tcl
