...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW10_FFT_FPGA+ARM/HW10_FFT_FPGA+ARM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pro_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pro_wrapper.tcl -notrace
