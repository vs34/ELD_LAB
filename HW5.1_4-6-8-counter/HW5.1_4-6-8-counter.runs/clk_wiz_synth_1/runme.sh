...
HD_PWD='/home/vs/funtion/verilog/ELD_LAB/HW5.1_4-6-8-counter/HW5.1_4-6-8-counter.runs/clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz.tcl
