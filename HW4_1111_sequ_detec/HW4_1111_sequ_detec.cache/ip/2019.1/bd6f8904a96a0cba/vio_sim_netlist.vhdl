...
\wr_en[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_out_all is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \G_PROBE_OUT[1].wr_probe_out[1]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \G_PROBE_OUT[2].wr_probe_out[2]_i_1\ : label is "soft_lutpair13";
begin
...
\G_PROBE_OUT[0].wr_probe_out[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
probe_out_mem: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0FAC00AC"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_vio is
  ...
  attribute LC_TOTAL_PROBE_OUT_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_vio : entity is 3;
  attribute dont_touch : string;
...
DECODER_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_decoder
     port map (
      ...
      s_dwe_o => bus_dwe,
      s_rst_o => bus_rst,
      \wr_en_reg[2]_0\ => PROBE_OUT_ALL_INST_n_4,
      \wr_en_reg[2]_1\ => PROBE_OUT_ALL_INST_n_5,
      \wr_en_reg[2]_2\ => PROBE_OUT_ALL_INST_n_6
    );
...
PROBE_IN_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_in_one
     port map (
      ...
      Read_int_reg_0 => PROBE_OUT_ALL_INST_n_6,
      Read_int_reg_1 => PROBE_OUT_ALL_INST_n_5,
      Read_int_reg_2 => PROBE_OUT_ALL_INST_n_4,
      clk => clk,
      \out\ => bus_clk,
      s_daddr_o(3) => bus_addr(8),
      s_daddr_o(2 downto 0) => bus_addr(2 downto 0),
...
PROBE_OUT_ALL_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vio_v3_0_20_probe_out_all
     port map (
      ...
      Probe_out_reg(0) => Probe_out_reg(0),
      Q(0) => \^bus_di\,
      Read_int_i_3_0 => PROBE_OUT_ALL_INST_n_6,
      Read_int_i_4_0 => PROBE_OUT_ALL_INST_n_5,
      SR(0) => clear,
      clk => clk,
      in0 => committ,
      \out\ => bus_clk,
      ...
      s_den_o => bus_den,
      s_den_o_INST_0 => PROBE_OUT_ALL_INST_n_4,
      s_dwe_o => bus_dwe
    );
