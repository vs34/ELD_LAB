...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.design_test \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" \
       +incdir+"../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" \
       +incdir+"../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" \
       +incdir+"../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ip/design_test_processing_system7_0_0" \
