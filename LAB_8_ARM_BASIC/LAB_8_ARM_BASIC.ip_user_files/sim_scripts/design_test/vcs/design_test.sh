...
#
# Generated by Vivado on Tue Oct 31 09:39:42 IST 2023
...
# Script info
echo -e "design_test.sh - Script generated by export_simulation (Vivado v2019.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ip/design_test_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_5 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ip/design_test_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/d4a8/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_7 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ip/design_test_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ipshared/8c62/hdl" +incdir+"$ref_dir/../../../../LAB_8_ARM_BASIC.srcs/sources_1/bd/design_test/ip/design_test_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_test/ip/design_test_processing_system7_0_0/sim/design_test_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/design_test/sim/design_test.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_test xil_defaultlib.glbl -o design_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc design_test_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./design_test.sh -help\" for more information)\n"
    exit 1
  fi
